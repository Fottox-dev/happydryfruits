...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'miti' ),
	'page_title'           => esc_html__( 'Theme Options', 'miti' ),
	...
	'global_variable'      => 'miti_theme_options',
...
/*** Color Scheme Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Color Scheme', 'miti' )
	,'id'               => 'color-scheme-tab'
	,'desc'             => ''
	,'icon'             => 'el el-brush'
...
/*** Typography Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Typography', 'miti' )
	,'id'               => 'typography-tab'
	,'desc'             => ''
	,'icon'             => 'el el-font'
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Portfolio Details', 'miti' )
...
/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'WooCommerce', 'miti' )
	,'id'               => 'woocommerce-tab'
	,'desc'             => ''
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Shop/Product Category', 'miti' )
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Product Details', 'miti' )
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Custom Code', 'miti' )
	,'id'               => 'custom-code-tab'
	,'desc'             => ''
	,'icon'             => 'el el-edit'
