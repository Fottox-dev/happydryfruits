...
$blog_thumb_size = 'miti_blog_thumb';
...
if( $theme_options['ts_blog_details_tags'] ){
	$post_class[] = 'show-tags';
}
		...
		<div class="entry-content <?php echo !$show_blog_thumbnail?'no-featured-image':'' ?>">
			...
			<?php if( $theme_options['ts_blog_date'] || $theme_options['ts_blog_author'] || $theme_options['ts_blog_comment'] || $theme_options['ts_blog_categories'] ): ?>
				<div class="entry-meta-middle">
					...
					<span class="comment-count">
						<?php
						$comment_count = miti_get_post_comment_count();
						echo sprintf( _n('%d comment', '%d comments', $comment_count, 'miti'), $comment_count );
						?>
					</span>
					<?php endif; ?>
			...
			?>
				<div class="entry-summary">
					...
					<?php
						if( $max_words != '-1' ){
							miti_the_excerpt_max_words($max_words, $post, $strip_tags, '', true);
						}
			...
			<div class="entry-meta-bottom">
				<a class="button-readmore button-text" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read more', 'miti'); ?></a>
			</div>
			<?php endif; ?>
